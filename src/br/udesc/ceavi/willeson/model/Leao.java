...
public class Leao extends Peca {
    ...
    public Leao(String img, int posicao, int valor) {
        this.img = img;
    ...
    private void verificaSairArmadilha(String getThis) {
        if (getImg().equalsIgnoreCase(getThis + "\\TQ01Leao.png")) {
            setImg(getThis + "\\01Leao.png");
