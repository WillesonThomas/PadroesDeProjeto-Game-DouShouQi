...
public class Lobo extends Peca {
    ...
    public Lobo(String img, int posicao, int valor) {
        this.img = img;
    ...
    private void verificaSairArmadilha(String getThis) {
        if (getImg().equalsIgnoreCase(getThis + "\\TQ08lobo.png")) {
            setImg(getThis + "\\08lobo.png");
