...
public class Gato extends Peca {
    ...
    public Gato(String img, int posicao, int valor) {
        this.img = img;
    ...
    private void verificaSairArmadilha(String getThis) {
        if (getImg().equalsIgnoreCase(getThis + "\\TQ06gato.png")) {
            setImg(getThis + "\\06gato.png");
